...
class NewsController extends BackController
{
  ...
  public function executeListComments(HTTPRequest $request)
  {
    ...
    $this->page->addVar('listComments', $commentManager->getList());
    $this->page->addVar('listNews', $newsManager->getList());
  }
  ...
  public function executeUpdateComment(HTTPRequest $request)
  {
    ...
    if ($request->method() == 'POST')
    {
      $comment = new Comment([
        ...
        'numberSignal' => $this->managers->getManagerOf('Comments')->get($request->getData('id'))->numberSignal()
      ]);
    }
    else
    {
